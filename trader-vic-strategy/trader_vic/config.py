...
VOLATILITY_MEDIAN = 7        # 月均 2% 走势次数历史中位数
...
ENV_ADAPTATION = {
    "TRENDING_BULL": {
        ...
        "min_rrr": 2.5,
        "position_cap": 1.0,
        "preferred_signals": ["123_FULL", "2B", "THREE_DAY_PULLBACK"],
    ...
    "LOW_VOL": {
        ...
        "min_rrr": 3.0,
        "position_cap": 0.8,
        "preferred_signals": ["123_FULL", "THREE_DAY_PULLBACK"],
    },
    "CRISIS": {
        "signal_boost": 0.0,
        "kelly_mult": 0.0,
...
TRAILING_STOP_ACTIVATE = 0.50      # 盈利达 RRR 的 50% 时移止损保本
